...
enum ImGuiStyleEnum
{
    ...
    ImGuiStyle_Design,   // Posted by @usernameiwantedwasalreadytaken here: https://github.com/ocornut/imgui/issues/707
                         // (hope I can use it)
    ...
    ImGuiStyle_C64, // Posted by @Nullious here: https://gist.github.com/Nullious/2d598963b346c49fa4500ca16b8e5c67 (hope
                    // I can use it)
    ImGuiStyle_PhotoStore, // Posted by @Derydoca here: https://github.com/ocornut/imgui/issues/707 (hope I can use it)
    ImGuiStyle_CorporateGreyFlat,   // Posted by @malamanteau here: https://github.com/ocornut/imgui/issues/707 (hope I
                                    // can use it)
    ImGuiStyle_CorporateGreyFramed, // Posted by @malamanteau here: https://github.com/ocornut/imgui/issues/707 (hope I
                                    // can use it)
    ImGuiStyle_VisualDark, // Posted by @mnurzia here: https://github.com/ocornut/imgui/issues/2529 (hope I can use it)
    ImGuiStyle_SteamingLife, // Posted by @metasprite here: https://github.com/ocornut/imgui/issues/707 (hope I can use
                             // it)
    ImGuiStyle_SoftLife,     // Just a quick variation of the ImGuiStyle_SteamingLife style
    ImGuiStyle_GoldenBlack,  // Posted by @CookiePLMonster here: https://github.com/ocornut/imgui/issues/707 (hope I can
                             // use it)
    ImGuiStyle_Windowed,     // Badly adapted from the Win98-DearImgui customization made by @JakeCoxon in his fork here
                             // https://github.com/JakeCoxon/imgui-win98 (hope I can use it)
    ImGuiStyle_OverShiftedBlack, // Posted by @OverShifted here: https://github.com/ocornut/imgui/issues/707 (hope I can
                                 // use it)
    ImGuiStyle_AieKickGreenBlue, // Posted by @aiekick here: https://github.com/ocornut/imgui/issues/707 (hope I can use
                                 // it)
    ImGuiStyle_AieKickRedDark,   // Posted by @aiekick here: https://github.com/ocornut/imgui/issues/707 (hope I can use
                                 // it)
...
// The drawback is that it's not possible to serialize/deserialize a style together with other stuff (for example 2
// styles together) into/from a single file. And it's not possible to serialize/deserialize a style into/from a memory
// buffer too.
...
IMGUI_API void ChangeStyleColors(ImGuiStyle& style, float satThresholdForInvertingLuminance = .1f,
                                 float shiftHue = 0.f);

// Handy wrapper to a combo to select the style:
IMGUI_API bool SelectStyleCombo(const char* label, int* selectedIndex, int maxNumItemsToDisplay = ImGuiStyle_Count,
                                ImGuiStyle* styleToChange = NULL);
