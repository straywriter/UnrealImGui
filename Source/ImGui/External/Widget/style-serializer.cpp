...
bool LoadStyle(const char* filename, ImGuiStyle& style)
{
    ...
    for (const char* line_start = f_data; line_start < buf_end;)
    {
        ...
        else if (name[0] != '\0')
        {
            ...
            // parsing 'name' here by filling the fields above
            {
                ...
                else if (strcmp(name, "WindowMenuButtonPosition") == 0)
                {
                    npi = 1;
                    pi[0] = reinterpret_cast<int*>(&style.WindowMenuButtonPosition);
                }
                else if (strcmp(name, "ChildRounding") == 0 || strcmp(name, "ChildWindowRounding") == 0)
                {
                    npf = 1;
                    pf[0] = &style.ChildRounding;
                }
                else if (strcmp(name, "ChildBorderSize") == 0)
                {
                    npf = 1;
                    pf[0] = &style.ChildBorderSize;
                }
                else if (strcmp(name, "PopupRounding") == 0)
                {
                    npf = 1;
                    pf[0] = &style.PopupRounding;
                }
                ...
                else if (strcmp(name, "IndentSpacing") == 0)
                {
                    npf = 1;
                    pf[0] = &style.IndentSpacing;
                }
                ...
                else if (strcmp(name, "WindowFillAlphaDefault") == 0)
                {
                    npf = 1;
                    pf[0] = &WindowFillAlphaDefault;
                }
                else if (strcmp(name, "ScrollbarRounding") == 0)
                {
                    npf = 1;
                    pf[0] = &style.ScrollbarRounding;
                }
                else if (strcmp(name, "WindowTitleAlign") == 0)
                {
                    npf = 2;
                    pf[0] = &style.WindowTitleAlign.x;
                    pf[1] = &style.WindowTitleAlign.y;
                }
                else if (strcmp(name, "ButtonTextAlign") == 0)
                {
                    npf = 2;
                    pf[0] = &style.ButtonTextAlign.x;
                    pf[1] = &style.ButtonTextAlign.y;
                }
                ...
                else if (strcmp(name, "ScrollbarSize") == 0)
                {
                    npf = 1;
                    pf[0] = &style.ScrollbarSize;
                }
                ...
                else if (strcmp(name, "DisplayWindowPadding") == 0)
                {
                    npf = 2;
                    pf[0] = &style.DisplayWindowPadding.x;
                    pf[1] = &style.DisplayWindowPadding.y;
                }
                else if (strcmp(name, "DisplaySafeAreaPadding") == 0)
                {
                    npf = 2;
                    pf[0] = &style.DisplaySafeAreaPadding.x;
                    pf[1] = &style.DisplaySafeAreaPadding.y;
                }
                else if (strcmp(name, "AntiAliasedLines") == 0)
                {
                    npb = 1;
                    pb[0] = &style.AntiAliasedLines;
                }
                else if (strcmp(name, "AntiAliasedLinesUseTex") == 0)
                {
                    npb = 1;
                    pb[0] = &style.AntiAliasedLinesUseTex;
                }
                else if (strcmp(name, "AntiAliasedFill") == 0 || strcmp(name, "AntiAliasedShapes") == 0)
                {
                    npb = 1;
                    pb[0] = &style.AntiAliasedFill;
                }
                else if (strcmp(name, "CurveTessellationTol") == 0)
                {
                    npf = 1;
                    pf[0] = &style.CurveTessellationTol;
                }
                else if (strcmp(name, "CircleSegmentMaxError") == 0)
                {
                    npf = 1;
                    // pf[0] = &style.CircleSegmentMaxError;
                }
                else if (strcmp(name, "TabRounding") == 0)
                {
                    npf = 1;
                    pf[0] = &style.TabRounding;
                }
                ...
                {
                    npf = 1;
                    pf[0] = &style.TabMinWidthForCloseButton;
                }
                else if (strcmp(name, "ColorButtonPosition") == 0)
                {
                    npi = 1;
                    pi[0] = reinterpret_cast<int*>(&style.ColorButtonPosition);
                }
                else if (strcmp(name, "SelectableTextAlign") == 0)
                {
                    npf = 2;
                    pf[0] = &style.SelectableTextAlign.x;
                    pf[1] = &style.SelectableTextAlign.y;
                }
                // all the colors here
                else
                {
            ...
            */
            ...
            if (style.WindowTitleAlign.x < 0 || style.WindowTitleAlign.x > 1)
                style.WindowTitleAlign.x = 0.f;
            if (style.WindowTitleAlign.y < 0 || style.WindowTitleAlign.y > 1)
                style.WindowTitleAlign.y = 0.5f;
            //---------------------------------------------------------------------------------
            // Fix FLT_MAX restoring
            if (style.TabMinWidthForCloseButton > (FLT_MAX - 0.002f))
    ...
    if (WindowFillAlphaDefault >= 0.f)
        style.Colors[ImGuiCol_WindowBg].w *= WindowFillAlphaDefault;
...
bool SelectStyleCombo(const char* label, int* selectedIndex, int maxNumItemsToDisplay, ImGuiStyle* styleToChange)
{
    ...
    changed = ImGui::Combo(label, selectedIndex, GetDefaultStyleNames(), ImGuiStyle_Count, maxNumItemsToDisplay);
    if (changed)
    {
...
{
    if (styleEnum < 0 || styleEnum >= ImGuiStyle_Count)
        return false;
    style = ImGuiStyle();
    switch (styleEnum)
    {
